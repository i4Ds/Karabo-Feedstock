...
- [fftw](https://anaconda.org/conda-forge/fftw/files): nompi, openmpi, mpich -> Currently karabo and therefore it's feedstock doesn't use this wheel, but instead the fftw of the feedstock itself. The reasons are unknown to me ([Lukas113](https://github.com/Lukas113)). I think we can replace our feedstock build with a wheel from conda-forge.
